 ...
 * Author: Raphael
 *
 * Created on May 21, 2022, 4:27 PM
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void setIO(){
    //configurar I/O
    TRISA = 0b11111111;     //SETA TODAS AS PORTAS AN COMO INPUT
    TRISB = 0b00000000;     //SETA TODAS AS PORTAS RB COMO OUTPUT
    TRISC = 0b11111111;     //SETA TODAS AS PORTAS RC COMO INPUT
    TRISD = 0b00000000;     //SETA TODAS AS PORTAS RD COMO OUTPUT
    TRISE = 0b00000111;     //SETA TODAS AS PORTAS RE<0:2> COMO INPUT
    
    ANSEL0 = 0b01100000;           //PINOS AN5 E AN6 SÃO ANALÓGICOS, O RESTANTE É DIGITAL
    ANSEL1 = 0b00000000;
    PORTA= 0b11111111;
    PORTB = 0b00000000;
    PORTC = 0b11111111;
